...
import { Users, Mail, Search, X, Filter, Trash2, ArrowUpDown, ArrowUp, ArrowDown, Phone } from 'lucide-react';
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/30 border-b">
                    ...
                    <TableHead className="min-w-[170px] px-3">Applied/Fit For</TableHead>
