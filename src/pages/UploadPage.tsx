...
export default function UploadPage() {
  ...
  const handleVectorize = async () => {
    ...
    // Wait a moment then mark all complete
    ...
    toast.success('Vectorization Complete: 15 Candidates Processed', {
      description: 'AI has analyzed and matched candidates to your job orders.'
    });
      ...
      >
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">
            CV Ingestion & Vectorization
          </h1>
          <p className="text-muted-foreground">
            Upload candidate CVs to enable AI-powered matching with your job orders.
          </p>
        </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Supports PDF, DOCX files • Click to browse
              </p>
            </div>
          </div>
        </div>
        ...
        <AnimatePresence>
          {files.length > 0 && (
            <motion.div
              ...
              className="bg-card rounded-xl border shadow-sm mb-6 overflow-hidden"
            >
        ...
        <div className="flex justify-center">
          <Button
            ...
            disabled={files.length === 0 || isProcessing || isVectorized}
